...
const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "departments-designations", label: "Departments & Designations" },
  ...
  },
  {
    ...
    children: [
      { key: "exam-dashboard", label: "Dashboard" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "student-fees", label: "Student Fee Details" },
      ...
      { key: "student-fee-reports", label: "Student Fee Reports" },
      { key: "due-reports", label: "Due Reports" },
      { key: "finance-settings", label: "Finance Settings" },
    ],
  },
  {
    key: "timetable", label: "Timetable", icon: "calendar_month",
    children: [
      { key: "timetable-dashboard", label: "Dashboard" },
